...
public class ModularPaxel extends ItemModularHandheld { // 声明一个名为ModularNecklace的公共类，它继承自ModularItem并实现ICurio接口。
    //部件类型/槽位——[slot]
    public final static String modular_paxel_pickaxe = "modular_paxel/pickaxe";
    public final static String modular_paxel_handle = "modular_paxel/handle";
    public final static String modular_paxel_axe = "modular_paxel/axe";
    public final static String modular_paxel_claw = "modular_paxel/claw";
    public final static String modular_paxel_shovel = "modular_paxel/shovel";
    public final static String modular_paxel_blade = "modular_paxel/blade";
    public final static String modular_paxel_hammer = "modular_paxel/hammer";
    public final static String modular_paxel_socket = "modular_paxel/socket";
    // --- 物品标识符 ---
    /*** 模块化项链在模组内的唯一标识符。* 这个标识符用于在NBT数据、配方和其他模组交互中引用该物品。*/
    public final static String identifier = "modular_paxel";
    ...
    private static final GuiModuleOffsets minorOffsets = new GuiModuleOffsets(
            ...
            -12, -3);
    // --- 物品实例 ---
    /*** 使用ObjectHolder注解，使得Forge在加载时能够自动获取已注册的“tetra:modular_paxel”物品实例。
     * 这允许其他模组或代码直接通过`ModularNecklace.instance`来访问这个物品，而无需手动注册和查找。
     * `registryName = "item"` 指定了要查找的注册表类型是物品。
     * `value = "tetra:modular_paxel"` 指定了该物品在物品注册表中的名称。
     * 注意：此字段在编译时和运行时可能存在依赖关系，确保“tetra:modular_paxel”已正确注册。*/
    //modular_paxel算是类似“单头工具”、“双头工具”的物品必备ID
    @ObjectHolder(
            registryName = "item",
            value = "tetra:modular_paxel"
    )
    ...
    public ModularPaxel() {
        ...
        canHone = true;
        //设置主要部件有什么
        majorModuleKeys = new String[]{modular_paxel_pickaxe,  modular_paxel_handle,modular_paxel_axe, modular_paxel_claw,modular_paxel_shovel,
                modular_paxel_blade,modular_paxel_hammer};
        //设置次要部件有什么
        minorModuleKeys = new String[]{modular_paxel_socket};
        // 定义该项链所必需的模块（Required Modules）。游戏会确保这些模块至少存在一个，否则物品可能无法正常工作或显示。
        requiredModules = new String[]{modular_paxel_pickaxe, modular_paxel_handle,modular_paxel_axe, modular_paxel_shovel,modular_paxel_claw,
                modular_paxel_blade,modular_paxel_hammer};
        //可修复
